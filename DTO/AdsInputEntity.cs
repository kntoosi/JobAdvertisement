...
namespace CrouseServiceAdvertisement.DTO
{
    public class AdsInputEntity
	{
		...
		//public AdsInputEntity(int Id_, short WrkCategory_Id_, int PbPersonnel_Id_, string JobTitle_, short WrkHistory_Id_, short CopTyp_Id_, short WrkShift_Id_, short WrkPlace_Id_, short Gender_Id_, short Salary_Id_, bool DutyStatus_, byte AgeFrom_, byte AgeTo_, string Description_, bool PhysicalDisability_, int ExpirationDateSh_, DateTime ExpirationTimeM_, int DocDate_, string DocTime_, DateTime LogDateTime_, int PbPersonnel_Id2_, int ConfirmDate_, string ConfirmTime_, string ConfirmDesc_, short AdsStateLST_Id_, bool Active_, short AdsJobPositionLST_Id_)
		public AdsInputEntity( short WrkCategory_Id_, string JobTitle_, short WrkHistory_Id_, short CopTyp_Id_, short WrkShift_Id_, short WrkPlace_Id_, short Gender_Id_, short Salary_Id_, bool DutyStatus_, byte AgeFrom_, byte AgeTo_, string Description_, bool PhysicalDisability_, int ExpirationDateSh_, DateTime ExpirationTimeM_,  string ConfirmDesc_, short AdsStateLST_Id_, bool Active_, short AdsJobPositionLST_Id_)
		{
			//this.Id = Id_;
